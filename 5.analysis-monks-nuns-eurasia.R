...
data <- subset(data,celibacy_cat_rev!=0) # subset the data by the presence of celibacy
...
strat <- data$class - 1 # there are no societies without any sort of class stratification (level 1)
religion <- data$religion
language <- data$language
data <- data.frame(cbind(monks,nuns,trans_gr,trans_br,marriage_monk,marriage_nun,inher_s,strat,religion,language))
data <- data[complete.cases(data),] # N=34
...
write.csv(data.frame(monk_trans_prec),file="monk_tr_eur_prec.csv")
monk_trans_post <- extract.samples(monk_trans,pars=c("a","bT","sigma_phy")) 
write.csv(data.frame(monk_trans_post),file="monk_tr_eur_post.csv")
...
monk_trans_prec <- data.frame(round(monk_trans_prec,2))
write.csv(data.frame(monk_trans_prec),file="monk_tr_rel_eur_prec.csv")
monk_trans_post <- extract.samples(monk_trans,pars=c("a","bT","sigma_a","sigma_bT","sigma_phy")) 
write.csv(data.frame(monk_trans_post),file="monk_tr_rel_eur_post.csv")
...
write.csv(data.frame(nun_trans_prec),file="nun_tr_eur_prec.csv")
nun_trans_post <- extract.samples(nun_trans,pars=c("a","bT","sigma_phy")) 
write.csv(data.frame(nun_trans_post),file="nun_tr_eur_post.csv")
...
nun_trans_prec <- data.frame(round(nun_trans_prec,2))
write.csv(data.frame(nun_trans_prec),file="nun_tr_rel_eur_prec.csv")
nun_trans_post <- extract.samples(nun_trans,pars=c("a","bT","sigma_a","sigma_bT","sigma_phy")) 
write.csv(data.frame(nun_trans_post),file="nun_tr_rel_eur_post.csv")
...
write.csv(data.frame(monk_marit_prec),file="monk_mar_eur_prec.csv")
monk_marit_post <- extract.samples(monk_marit,pars=c("a","bM","sigma_phy")) 
write.csv(data.frame(monk_marit_post),file="monk_mar_eur_post.csv")
...
monk_marit_prec <- data.frame(round(monk_marit_prec,2))
write.csv(data.frame(monk_marit_prec),file="monk_mar_rel_eur_prec.csv")
monk_marit_post <- extract.samples(monk_marit,pars=c("a","bM","sigma_a","sigma_bM","sigma_phy")) 
write.csv(data.frame(monk_marit_post),file="monk_mar_rel_eur_post.csv")
...
write.csv(data.frame(nun_marit_prec),file="nun_mar_eur_prec.csv")
nun_marit_post <- extract.samples(nun_marit,pars=c("a","bM","sigma_phy")) 
write.csv(data.frame(nun_marit_post),file="nun_mar_eur_post.csv")
...
nun_marit_prec <- data.frame(round(nun_marit_prec,2))
write.csv(data.frame(nun_marit_prec),file="nun_mar_rel_eur_prec.csv")
nun_marit_post <- extract.samples(nun_marit,pars=c("a","bM","sigma_a","sigma_bM","sigma_phy")) 
write.csv(data.frame(nun_marit_post),file="nun_mar_rel_eur_post.csv")
...
write.csv(data.frame(monk_inher_prec),file="monk_in_eur_prec.csv")
monk_inher_post <- extract.samples(monk_inher,pars=c("a","bI","sigma_phy")) 
write.csv(data.frame(monk_inher_post),file="monk_in_eur_post.csv")
...
monk_inher_prec <- data.frame(round(monk_inher_prec,2))
write.csv(data.frame(monk_inher_prec),file="monk_in_rel_eur_prec.csv")
monk_inher_post <- extract.samples(monk_inher,pars=c("a","bI","sigma_a","sigma_bI","sigma_phy")) 
write.csv(data.frame(monk_inher_post),file="monk_in_rel_eur_post.csv")
