...
data <- data.frame(cbind(celibacy,trans,marriage,inher,strat,inher,religion,language))
data <- data[complete.cases(data),] # N=333
...
write.csv(data.frame(trans_prec),file="cel_tr_prec.csv")
trans_post <- extract.samples(trans,pars=c("a","bT","sigma_phy")) 
write.csv(data.frame(trans_post),file="cel_tr_post.csv")
...
trans_prec <- data.frame(round(trans_prec,2))
write.csv(data.frame(trans_prec),file="cel_tr_rel_prec.csv")
trans_post <- extract.samples(trans,pars=c("a","bT","sigma_a","sigma_bT","sigma_phy")) 
write.csv(data.frame(trans_post),file="cel_tr_rel_post.csv")
...
write.csv(data.frame(marit_prec),file="cel_mar_prec.csv")
marit_post <- extract.samples(marit,pars=c("a","bM","sigma_phy")) 
write.csv(data.frame(marit_post),file="cel_mar_post.csv")
...
marit_prec <- data.frame(round(marit_prec,2))
write.csv(data.frame(marit_prec),file="cel_mar_rel_prec.csv")
marit_post <- extract.samples(marit,pars=c("a","bM","sigma_a","sigma_bM","sigma_phy")) 
write.csv(data.frame(marit_post),file="cel_mar_rel_post.csv")
...
write.csv(data.frame(inher_prec),file="cel_in_prec.csv")
inher_post <- extract.samples(inher,pars=c("a","bI","sigma_phy")) 
write.csv(data.frame(inher_post),file="cel_in_post.csv")
...
inher_prec <- data.frame(round(inher_prec,2))
write.csv(data.frame(inher_prec),file="cel_in_rel_prec.csv")
inher_post <- extract.samples(inher,pars=c("a","bI","sigma_a","sigma_bI","sigma_phy")) 
write.csv(data.frame(inher_post),file="cel_in_rel_post.csv")
